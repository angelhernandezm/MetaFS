========================================================================
    ACTIVE TEMPLATE LIBRARY : MetaFsExt Project Overview
========================================================================

AppWizard has created this MetaFsExt project for you to use as the starting point for
...
MetaFsExt.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (MetaFsExt.h)
        GUID definitions                                (MetaFsExt_i.c)
        A type library                                  (MetaFsExt.tlb)
        Marshaling code                                 (MetaFsExt_p.c and dlldata.c)

MetaFsExt.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in MetaFsExt.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named MetaFsExt.pch and a precompiled types file named StdAfx.obj.
...
MetaFsExtps.vcxproj
	...
	dlldata.c, MetaFsExt_i.c and MetaFsExt_p.c which are required
	to build the proxy/stub DLL.

MetaFsExtps.vcxproj.filters
